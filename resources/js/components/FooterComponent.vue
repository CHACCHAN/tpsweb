<script setup>
    ...
    const FooterTags = [
        ...
        {
            'title': 'X',
            'url': 'http://twitter.com/share?text=tps-photo-stidio-in-wotb%20%E3%83%9A%E3%83%BC%E3%82%B8%EF%BC%81&url=https%3A%2F%2Ftps-photo-stidio-in-wotb.jimdofree.com%2F',
            'icon': `
                ...
                <div class="col-12 col-md-5">
                    <div class="my-5">
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            <div class="text-secondary border-top border-secondary" style="font-size: 10px;">
                                Powered By CHACCHAN SYSTEM
                            </div>
                        </div>
                    </div>
                </div>
